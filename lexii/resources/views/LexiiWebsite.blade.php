...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="77">
    <nav class="navbar navbar-expand-md fixed-top navbar-light" id="mainNav">
        <div class="container"><a class="navbar-brand" href="#"></a><button data-bs-toggle="collapse" class="navbar-toggler navbar-toggler-right" data-bs-target="#navbarResponsive" type="button" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation" value="Menu"><i class="fa fa-bars"></i></button>
            <div class="collapse navbar-collapse" id="navbarResponsive"><img src="./img/logo%20lexii.jpg" style="width: 100px;">
    ...
    <header class="masthead" style="background-image:url('./img/intro-bg.jpg');">
        <div data-aos="fade" class="intro-body">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <p class="intro-text">A world without loneliness</p><a class="btn btn-link btn-circle" role="button" href="#about"><i class="fa fa-angle-double-down animated"></i></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="text-center content-section" id="about">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <h2>About Lexii</h2>
                    <p>At LEXII we understand the profound impact of loneliness on individuals well-being. Our mission is to make thoughtful solutions to make a better world without loneliness.</p>
                    <p>Join us on our journey where empathy meets innovation. Explore our robots, designed to break the chains of isolation. At LEXII we believe in the power of technology and are committed to create a world where no one feels truly alone.</p>
                    <p>Embark with us on a path to shatter the barriers of loneliness, unveiling a world where every individual finds meaningful connections.</p>
                </div>
            </div>
        </div>
    </section>
    <section class="text-center download-section content-section" id="download" style="background-image:url('./img/downloads-bg.jpg');">
        <div class="container">
            <div class="col-lg-8 mx-auto">
                <h1>Download the app</h1>
                <p>You can download LEXII for free.</p><button class="btn btn-primary btn-lg btn-default" type="button">visit download page</button>
            </div>
        </div>
    </section>
    <section class="text-center content-section" id="contact">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <h2>Contact us</h2>
                    <p>Feel free to leave us a message if you have questions about our robot.</p>
